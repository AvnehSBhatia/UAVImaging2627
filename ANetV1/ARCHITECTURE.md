...
| v16 | **Auxiliary cosine-weave texture channel** (D66, user-directed): v13 trunk + 1,800-param spatial multi-cosine weave over s4 texture energy, bounded gate, D24-bounded frequencies. 27,012 params. Identity-at-init vs pinned v13_best = 0.0. See §16.4. | single-variable test of the texture hypothesis; falsifier = fp/img at held recall. From-scratch gate: 2× slower but lowest bg contamination of any arch (0.227) |
